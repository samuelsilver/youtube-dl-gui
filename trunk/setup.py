...
if os.path.exists("youtube-dl-gui-0.2-win32"):
    shutil.rmtree("youtube-dl-gui-0.2-win32")
if os.path.exists("youtube-dl-gui-0.2-linux"):
    shutil.rmtree("youtube-dl-gui-0.2-linux")
...
if not os.path.exists("youtube-dl-gui-0.2-linux"):
    os.mkdir("youtube-dl-gui-0.2-linux")
